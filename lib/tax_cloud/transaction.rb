module TaxCloud #:nodoc:
  ...
  class Transaction < Record
    ...
    def lookup
      ...
      response = client.request :lookup, request_params
    ...
    def authorized(options = {})
      ...
      response = client.request :authorized, request_params
    ...
    def captured(options = {})
      ...
      response = client.request :captured, request_params
    ...
    def authorized_with_capture(options = {})
      ...
      response = client.request :authorized_with_capture, request_params
    ...
    def returned(options = {})
      ...
      response = client.request :returned, request_params
