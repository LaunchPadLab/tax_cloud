...
You can also specify a different <tt>TaxCloud::Client</tt> for each <tt>TaxCloud::Address</tt>

    client = TaxCloud::Client.new('other_tax_cloud_api_login_id', 'other_tax_cloud_api_key')
